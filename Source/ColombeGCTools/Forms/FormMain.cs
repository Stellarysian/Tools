...
using ColombeGCTools.Game;
using ColombeGCTools.Pages;
using ColombeGCTools.Properties;
using ColombeGCTools.Utils;

namespace ColombeGCTools.Forms
{
    internal partial class FormMain : Form
    {
        ...
        private void FormMain_Load(object sender, EventArgs e)
        {
            ...
            Text += "  - by Stellarysian  - v" + Common.AppVersion.ToString(3);
#if DEBUG
            Text += "-debug";
#endif
            if (DesignMode) return;
